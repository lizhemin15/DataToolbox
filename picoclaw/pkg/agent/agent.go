...
import (
	...
	"github.com/YOUR_USERNAME/DataToolbox/picoclaw/pkg/audio/asr"
	...
	"github.com/YOUR_USERNAME/DataToolbox/picoclaw/pkg/constants"
	...
	"github.com/YOUR_USERNAME/DataToolbox/picoclaw/pkg/media"
	"github.com/YOUR_USERNAME/DataToolbox/picoclaw/pkg/providers"
	"github.com/YOUR_USERNAME/DataToolbox/picoclaw/pkg/routing"
	"github.com/YOUR_USERNAME/DataToolbox/picoclaw/pkg/session"
	"github.com/YOUR_USERNAME/DataToolbox/picoclaw/pkg/state"
	"github.com/YOUR_USERNAME/DataToolbox/picoclaw/pkg/utils"
)
...
func (al *AgentLoop) Close() {
	al.mcp.takeManager() // MCP stub

	// MCP manager close skipped (stub)
...
func (al *AgentLoop) ReloadProviderAndConfig(
	...
	// oldMCPManager close skipped (stub)
	if oldEvolution != nil {
...
func (al *AgentLoop) runAgentLoop(
	...
	if opts.Dispatch.Channel() != "" &&
		...
		al.RecordLastChannel(channelKey)
	}
