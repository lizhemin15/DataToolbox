        ...
        blocksData.forEach(b => {
            ...
            block.innerHTML = `
                <div class="cluster-block-header" id="${headerId}" onclick="toggleClusterBlock(this)">
                    ...
                    <span class="cluster-block-chevron"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg></span>
                </div>
...
async function ensureQualityAuditScriptLoaded() {
    ...
    await loadLazyScript('quality-audit.js?v=1.3.83.1706.1706.1249.1249.1450.1450.2026091922');
}
